...
import { Github, Hammer, Terminal, User,Linkedin } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gray-950 text-white p-6 md:p-12">
      <div className="max-w-3xl mx-auto space-y-10">
        <header className="text-center">
          ...
          <p className="mt-2 text-gray-300 italic">Meet the creator and explore the tech behind the assistant</p>
        </header>
        ...
        <Card className="bg-gray-900 border border-gray-800 shadow-xl">
          <CardContent className="p-6 space-y-4">
            ...
            <ul className="list-disc list-inside text-gray-300 space-y-1">
              ...
              <li>📣 Feedback and collaboration are open  <a
